                ...
                <td class="actions">
                    <div class="btn-group btn-hspace">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li><a href="{{route('system.article.edit',[$new->id])}}">Edit Record</a></li>
                        <li class="divider"></li>
                      
                        <li><a class="action-delete" href="#" data-url="{{route('system.article.destroy',[$new->id])}}" data-toggle="modal" data-target="#confirm-delete" title="Remove Record">Remove Record</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
              @empty
              <td colspan="6" class="text-left"><i>No record found yet.</i> <a href="{{route('system.article.create')}}"><strong>Click here</strong></a> to create one.</td>
              @endforelse
            </tbody>
          </table>
